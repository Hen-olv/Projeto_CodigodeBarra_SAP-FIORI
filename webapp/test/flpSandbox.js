		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#projetocodigodebarra-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projetocodigodebarra-display": {
								"semanticObject": "projetocodigodebarra",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projetocodigodebarra",
									"url": sap.ui.require.toUrl("projetocodigodebarra")
								}
							}
						}
					}
